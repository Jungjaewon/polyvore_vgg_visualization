"""
base code is from https://github.com/utkuozbulak/pytorch-cnn-visualizations/blob/master/src/cnn_layer_visualization.py
...
class CNNLayerVisualization():
    ...
    def visualise_layer_with_hooks(self):
        ...
        random_image = np.uint8(np.random.uniform(150, 180, (256, 256, 3)))
